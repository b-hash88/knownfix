...
**Contents:** five complete fixes, a publishing decision tree, recovery commands, and release verification  
...
3. For supported CI providers, prefer npm Trusted Publishing through OIDC; use a scoped granular token only when OIDC is unavailable.
4. Treat E404 for a new package, a silent install, package-export probing, and peer-resolution errors as different branches. Prove the failure class before changing credentials.
